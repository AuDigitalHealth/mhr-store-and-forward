...
namespace DigitalHealth.StoreAndForward.Client.Models
{
    ...
    /// </summary>
    public partial class TimelineEventModel
    {
        /// <summary>
        /// Initializes a new instance of the TimelineEventModel class.
        /// </summary>
        ...
        public TimelineEventModel(string documentId = default(string), int? id = default(int?), System.DateTime? eventDateTime = default(System.DateTime?), string details = default(string), string type = default(string), string documentLink = default(string))
        {
